        ...
        <div style={{marginLeft: "10px"}}>
            ...
            <div style={{display: "flex"}}>
                    <div style={{padding: "10px"}}  className="col-md-3">
                        <div>
                            <label>Nome</label>
                            <input readOnly={habilitar} type="text" id="proNome" value={projeto.proNome || ""} onChange={(e) => handleChange(e, e.target.value)} className="form-control"></input>
                        </div>
                    </div>   
                    <div style={{padding: "10px"}}  className="col-md-1">
                        <div>
                            <label>Status</label>
                            <input readOnly={habilitar} type="text" id="proStatus" value={projeto.proStatus || ""} onChange={(e) => handleChange(e, e.target.value)} className="form-control"></input>
                        </div>
                    </div>
                    <div style={{padding: "10px"}}  className="col-md-2">
                        <div>
                            <label>Data de Inicio</label>
                            <input readOnly={habilitar} type="date" id="proDataInicio" value={projeto.proDataInicio || ""} onChange={(e) => handleChange(e, e.target.value)} className="form-control"></input>
                        </div>
                    </div>
                    <div style={{padding: "10px"}}  className="col-md-2">
                        <div>
                            <label>Data de Final</label>
                            <input readOnly={habilitar} type="date" id="proDataFinal" value={projeto.proDataFinal || ""} onChange={(e) => handleChange(e, e.target.value)} className="form-control"></input>
                        </div>
                    </div>
                </div>
